          ...
          <TabsContent value="faq">
            <div className="space-y-6">
              ...
              <Card className="bg-green-50 border-green-200">
                <CardContent className="p-6">
                  <h3 className="text-lg font-semibold text-green-800 mb-4">Gallery Questions</h3>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-white p-4 rounded-lg border border-green-200">
                      <h4 className="font-medium text-green-800 mb-2">Is the gallery a subscription?</h4>
                      <p className="text-sm text-green-700">
                        Nope, it's a one time payment.
                      </p>
                    </div>
                    <div className="bg-white p-4 rounded-lg border border-green-200">
                      <h4 className="font-medium text-green-800 mb-2">How long does the gallery remain active?</h4>
                      <p className="text-sm text-green-700">
                    ...
                    <div className="bg-white p-4 rounded-lg border border-green-200">
                      <h4 className="font-medium text-green-800 mb-2">Do I have to pay to enable the gallery for each of my WedUploader albums?</h4>
                      <p className="text-sm text-green-700">
                        You only have to pay once and the gallery feature will be unlocked for all your WedUploader albums.
                      </p>
                    </div>
                    <div className="bg-white p-4 rounded-lg border border-green-200">
                      <h4 className="font-medium text-green-800 mb-2">I enabled the gallery but I don't see any photos?</h4>
                      <p className="text-sm text-green-700">
